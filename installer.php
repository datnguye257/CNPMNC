        ...
        try {
            if ($this->isZip()) {
                ...
                if (
                    ...
                    BootstrapUtils::isPhpZipAvailable() &&
...
class ShellOutput
{
    ...
    private $output = [];
    private $code = -1;
    private $isCodeAvailable = true;
    public function __construct($output, $code, $method, $isCodeAvailable = true)
    {
        ...
        $this->code            = (int) $code;
        $this->method          = $method;
        $this->isCodeAvailable = (bool) $isCodeAvailable;
    }
    ...
    public function renderError()
    {
        ...
        <table class='settings'>
            <?php if ($this->boot->isZip()) { ?>
                <tr>
                    <td>ZipArchive:</td>
                    <td><?php echo BootstrapUtils::isPhpZipAvailable() ? '<i class="pass">Enabled</i>' : '<i class="fail">Disabled</i>'; ?> </td>
                </tr>
                <tr>
...
namespace {
    ...
    class InstallerBootstrapData {
        const ARCHIVE_FILENAME       = 'Dat_Lam_CPMNC_7a12afecaa4ea14b1096_20240111051413_archive.zip';
        const ARCHIVE_SIZE           = '96195912';
        const INSTALLER_DIR_NAME     = 'dup-installer';
        const PACKAGE_HASH           = '7a12afe-11051413';
        const SECONDARY_PACKAGE_HASH = '2a81bbe-11051413';
        const VERSION                = '4.5.14.2';
    }
